...
@Module({
  ...
  exports: [
    ...
    PrismaGroupStudentsRepository,
    PrismaGroupsRepository,
    PrismaOccurrenceAttachmentsRepository,
    PrismaOccurrenceAttendeesRepository,
    PrismaOccurrenceStudentsRepository,
    PrismaOccurrencesRepository,
    PrismaPedagoguesRepository,
